# Kim Schalk
# 25/08/2022
# Add Transaction Window Design - Version 1
...
name_label = Label(root, text="Transaction", font=("Comfortaa", 25, "bold"), bg=background_colour)
...
item_label.grid(row=1, column=0, columnspan=2, sticky="w", padx=20, pady=(20, 10))
item_entry = Entry(root, font=("Comfortaa", 10), bd=1)
item_entry.grid(row=2, column=0, columnspan=3, padx=15)
item_entry.config(width=40)
cost_label = Label(root, text="Cost:", bg=background_colour, font=("Comfortaa", 12, "bold"))
cost_label.grid(row=3, column=0, columnspan=2, sticky="w", padx=20, pady=(20, 10))
cost_entry = Entry(root, font=("Comfortaa", 10), bd=1)
cost_entry.grid(row=4, column=0, columnspan=3, padx=15)
cost_entry.config(width=40)

enter_button = Button(root, text="Enter", bg=button_colour, font=("Comfortaa", 12), bd=1, relief="solid")
enter_button.grid(row=5, column=0, columnspan=3, pady=(30, 20), ipadx=25)
